            ...
            for (int j = 0; j < item.getFfamilyList().get(i).getFComponentList().size(); j++) {
                ...
                if(item.getFfamilyList().get(i).getFComponentList().get(j).getFcoUserNotes().getP().size()==0){
                    ...
                    for (int k = 0; k < item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().size(); k++) {
                        ...
                        if(item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().get(k).getId().equals("")){
                            ...
                            ps.setString(2,item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().get(k).getId());
                            ps.setString(5,item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().get(k).getId());
                        }
                        ps.setString(1,item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().get(k).getType());
                        ps.setString(3, String.valueOf(item.getFfamilyList().get(i).getFComponentList().get(j).getFcoLevelling().getP().get(k).getCombo()));
                        ps.setString(4,item.getFfamilyList().get(i).getFComponentList().get(j).getId());
                        ps.addBatch();
                    }
                }
